...
\begin{document}
  ...
  \input{chapters/xdudla00-porting-Tang-to-Open-WRT-03-key-manegement-systems}
  \input{chapters/xdudla00-porting-Tang-to-Open-WRT-04-tang}
  \input{chapters/xdudla00-porting-Tang-to-Open-WRT-05-openwrt}
  \input{chapters/xdudla00-porting-Tang-to-Open-WRT-06-portability}
  \input{chapters/xdudla00-porting-Tang-to-Open-WRT-07-dependencies}
  \input{chapters/xdudla00-porting-Tang-to-Open-WRT-08-tang}
  \input{chapters/xdudla00-porting-Tang-to-Open-WRT-09-configuration}
  \input{chapters/xdudla00-porting-Tang-to-Open-WRT-10-contributing}
  \input{chapters/xdudla00-porting-Tang-to-Open-WRT-11-conclusion}
...
\fi
  ...
  % Přílohy / Appendices
  % ----------------------------------------------
  \input{chapters/xdudla00-porting-Tang-to-Open-WRT-30-appendix-A}
  \input{chapters/xdudla00-porting-Tang-to-Open-WRT-31-appendix-B}
  \input{chapters/xdudla00-porting-Tang-to-Open-WRT-32-appendix-C}
  % ----------------------------------------------
