...
\keywords[cs]{portovanie, Tang, OpenWrt, Clevis, Escrow, šifrovanie, LUKS, automatizácia}
\keywords[en]{porting, Tang, OpenWrt, Clevis, Escrow, encryption, LUKS, automation}
...
\fi
  \begin{flushleft}
   \bibliography{bibl/xdudla00-porting-Tang-to-Open-WRT-20-bibliography} 
  \end{flushleft}
