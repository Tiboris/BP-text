...
\fi
  ...
  \subfile{chapters/xdudla00-porting-Tang-to-Open-WRT-05-clevis}
  \subfile{chapters/xdudla00-porting-Tang-to-Open-WRT-06-openwrt}
  \subfile{chapters/xdudla00-porting-Tang-to-Open-WRT-07-conclusion}
...
\fi
  \begin{flushleft}
   \bibliography{bibl/xdudla00-porting-Tang-to-Open-WRT-20-literatura-bibliography}
  \end{flushleft}
...
% Prilohy / Appendices
% ----------------------------------------------
%\subfile{chapters/projekt-30-prilohy-appendices}
%\subfile{chapters/projekt-40-prilohy-ipluskal}
% ----------------------------------------------
\end{document}
