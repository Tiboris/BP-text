...
Before committing the changes we also found that the owner of the repository changed from 'joyent' to 'nodejs' so we addressed these changes as well by editing proper sections in the Makefile.
