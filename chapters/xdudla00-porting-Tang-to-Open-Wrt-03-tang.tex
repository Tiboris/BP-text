\chapter{Tang}\label{tang} \todo{re-factor chapter}
...
On Figure \ref{fig_tangmodel} you can see the Tang model.
It is very similar to Escrow model \ref{fig_escrowmodel} but there are some thing missing.
