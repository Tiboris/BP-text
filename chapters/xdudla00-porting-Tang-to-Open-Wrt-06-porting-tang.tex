...
Soon after this porting effort started, OpenWrt upstream was in a bad shape and almost dead for reasons we described in subsection \ref{LEDE} OpenWrt and LEDE.
