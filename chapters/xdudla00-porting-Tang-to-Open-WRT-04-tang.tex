...
A client performs an ECDH \cite{ecdh} key exchange using the McCallum-Relyea algorithm \ref{mrexchange} in order to generate the binding key.
...
\hline
\multicolumn{2}{c|}{Provisionong} & \multicolumn{2}{c|}{Recovery} \\ \hline  used
