...
\end{itemize}
When you save your configuration, the file .config will be created in the buildroot directory according to desired configuration.
...
Exit the TUI, and choose to save your settings\cite{build_owrt}.
