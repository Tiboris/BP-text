...
\section{Disk encryption with LUKS} \label{LUKS_disk}
...
Hard drive with a LUKS partition has notable structure see Figure \ref{fig_luksvol} LUKS volume structure for demonstration.
