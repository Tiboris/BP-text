...
Platform specific limitations are there because of the systemd replacement with xinetd implementation of super-server.
...
\paragraph{xinetd forwarding the stderr} output to the socket is a little problem as well.
